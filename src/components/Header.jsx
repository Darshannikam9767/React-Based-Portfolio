    ...
    <header className="absolute w-full z-50 transition-all duration-300">
        <div className=" container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
            ...
            className=" flex items-center">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100
                 flex items-center justify-center
                  text-purple-600 font-bold text-xl mr-3 shadow-xl/30">
                    D
                </div>
            ...
            onClick={openContactForm}
                ...
                className=" ml-4 px-4 py-2 rounded-xl shadow-xl/30
            ...
            bg-white dark:bg-gray-900 shadow-lg px-5 py-5 space-y-5">
                ...
                <div className=" border-t border-gray-200 pt-4 drak:border-gray-700">
                    ...
                    className="mt-4 block w-full bg-gradient-to-r
                     from-violet-600 to-violet-400 px-4 py-2 rounded-xl
                     font-bold hover:cursor-pointer hover:scale-98  duration-300"
                                        ...
                                        <label htmlFor="name" className="block
                                         ...
                                         className="w-full 
                                          px-4 py-2 border border-gray-600
                                           rounded-gray-600 rounded-lg focus:ring-2
