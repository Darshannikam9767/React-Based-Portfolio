...
const HeroSection = () => {
  return (
    ...
    lg:px-24 px-10 relative overflow-hidden">
        {/* left */}
        <div className="z-40 xl:mb-0 mb-[20%] bg-transparent">
            <motion.h1
            ...
            lg:text-2xl text-purple-200
            max-w-2xl">
                I deliver robust, production-ready
                websites and web apps with speed 
                and precision. Every Project is backed by
        ...
        scene="https://prod.spline.design/kVmH1odhkfowqT4l/scene.splinecode" />
